...
colnames_cleaned <- gsub("-", ".", substr(colnames(GeneMatrix_MGI), 1, 12))
GeneMatrix_DGAC <- subset(GeneMatrix_MGI, select = colnames_cleaned %in% DGAC_clinical$bcr_patient_barcode)
...
write.table(Phenotype_normal_DGAC, file="D:/KP/EKP_RKP/Scissor/Phenotype_normal_DGAC.csv", sep = ",", row.names=FALSE)
...
infos <- Scissor(bulk_dataset=GeneMatrix_normal_DGAC_input, sc_dataset=t.rna.df, phenotype=phenotype, tag = tag, alpha = 0.32, family = "binomial", Save_file = "D:/KP/EKP_RKP/Scissor/normal_DGAC.RData")
...
write.table(as.data.frame(Scissor_select), "D:/KP/EKP_RKP/Scissor/Scissor_normal_DGAC_a0.32.csv", sep = ",", row.names = T, col.names = T, quote = F)    # export meta.data of sc_dataset, you can check Scissor information

infos <- Scissor(bulk_dataset=GeneMatrix_normal_DGAC_input, sc_dataset=t.rna.df, phenotype=phenotype, tag = tag, alpha = 0.05, family = "binomial", Save_file = "D:/KP/EKP_RKP/Scissor/normal_DGAC_a0.05.RData")
Scissor_select <- rep(0, ncol(t.rna.df))
names(Scissor_select) <- colnames(t.rna.df)
Scissor_select[infos$Scissor_pos] <- 1
Scissor_select[infos$Scissor_neg] <- 2
write.table(as.data.frame(Scissor_select), "D:/KP/EKP_RKP/Scissor/Scissor_normal_DGAC_a0.05.csv", sep = ",", row.names = T, col.names = T, quote = F)    # export meta.data of sc_dataset, you can check Scissor information

infos <- Scissor(bulk_dataset=GeneMatrix_normal_DGAC_input, sc_dataset=t.rna.df, phenotype=phenotype, tag = tag, alpha = 0.01, family = "binomial", Save_file = "D:/KP/EKP_RKP/Scissor/normal_DGAC_a0.01.RData")
Scissor_select <- rep(0, ncol(t.rna.df))
names(Scissor_select) <- colnames(t.rna.df)
Scissor_select[infos$Scissor_pos] <- 1
Scissor_select[infos$Scissor_neg] <- 2
write.table(as.data.frame(Scissor_select), "D:/KP/EKP_RKP/Scissor/Scissor_normal_DGAC_a0.01.csv", sep = ",", row.names = T, col.names = T, quote = F)    # export meta.data of sc_dataset, you can check Scissor information
