...
DEG <- read.csv("D:/KP/EKP_RKP/EKP_vs.RKP_epithelial_DEG.csv", sep = ',')
head(DEG)
...
fwrite(fgseaResTidy, file="RKP_GSEA_results_KEGG.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy = read.csv('D:/KP/EKP_RKP/fgsea/tumor_by_type/RKP_GSEA_results_KEGG.csv', sep=",")
...
fwrite(fgseaResTidy_2, file="RKP_GSEA_results_REACTOME.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy_2 = read.csv('D:/KP/EKP_RKP/fgsea/tumor_by_type/RKP_GSEA_results_REACTOME.csv', sep=",")
...
fwrite(fgseaResTidy_5, file="RKP_GSEA_results_GOBP.csv", sep=",", sep2=c("", " ", ""))
fgseaTidy_5 <- read.csv('D:/KP/EKP_RKP/fgsea/tumor_by_type/RKP_GSEA_results_GOBP.csv',sep=',')
