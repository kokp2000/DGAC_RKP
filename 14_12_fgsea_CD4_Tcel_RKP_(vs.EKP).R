...
DEG <- read.csv("D:/KP/EKP_RKP/Cd4_Tcell_rank_by_type_fgsea.csv", sep = ',')
head(DEG)
...
fwrite(fgseaResTidy, file="RKP_CD4_Tcell_GSEA_results_KEGG.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy = read.csv('/mnt/d/KP/EKP_RKP/fgsea/tumor_by_type/RKP_CD4_Tcell_GSEA_results_KEGG.csv', sep=",")
...
plotEnrichment(msigdbr_list[["KEGG_TGF_BETA_SIGNALING_PATHWAY"]],
               ranks_1) + labs(title="KEGG_TGF_BETA_SIGNALING_PATHWAY")
plotEnrichment(msigdbr_list[["KEGG_ERBB_SIGNALING_PATHWAY"]],
               ranks_1) + labs(title="KEGG_ERBB_SIGNALING_PATHWAY")
plotEnrichment(msigdbr_list[["KEGG_MAPK_SIGNALING_PATHWAY"]],
               ranks_1) + labs(title="KEGG_MAPK_SIGNALING_PATHWAY")
...
fwrite(fgseaResTidy_2, file="RKP_CD4_Tcell_GSEA_results_REACTOME.csv", sep=",", sep2=c("", " ", ""))
fgseaResTidy_2 = read.csv('d:/KP/EKP_RKP/fgsea/Tcell/RKP_CD4_Tcell_GSEA_results_REACTOME.csv', sep=",")
...
fwrite(fgseaResTidy_5, file="RKP_CD4_Tcell_GSEA_results_GOBP.csv", sep=",", sep2=c("", " ", ""))
fgseaTidy_5 <- read.csv('/mnt/d/KP/EKP_RKP/fgsea/tumor_by_type/RKP_CD4_Tcell_GSEA_results_GOBP.csv',sep=',')
